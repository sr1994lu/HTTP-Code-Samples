...
class HTTPTranslator
{
     ...
     * @return string.
     */
    public function createReqXML($fromLanguage, $toLanguage, $category, $contentType, $user, $inputStrArr, $maxTranslation)
    {
...
try {
    ...
    //Input text Array.
    $inputStrArr = ['Wir versuchen, offensiven Wortschatz bzw.', 'Techniker arbeiten, um das Problem zu beheben'];
